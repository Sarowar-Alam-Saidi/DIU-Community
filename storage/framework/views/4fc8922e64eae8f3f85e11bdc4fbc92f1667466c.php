            ...
            <div class="col-lg-12 col-xl-6 order-lg-3 order-xl-2">
                    ...
                    <div class="card-body pl-4 pt-4 pr-4 pb-0">
                        ...
                        <div class="border-0 flex-1 position-relative shadow-top">
                            <form action="<?php echo e(url('/event-update',$editevent->id)); ?>" method="post" enctype="multipart/form-data">
                                <?php echo csrf_field(); ?>
                                <label class="form-label" for="example-textarea">Create Event Post</label>

                                <div class="form-group">
                                    <input class="form-control" type="date" name="time" required value="<?php echo e($editevent->time); ?>">
                                </div>

                                <div class="form-group">
                                    <select class="form-control" id="example-select" name="eventType" required>
                                        <option><?php echo e($editevent->eventType); ?></option>
                                ...
                                <div class="form-group">
                                    <textarea class="form-control" id="example-textarea" rows="5" name="description" required><?php echo e($editevent->description); ?></textarea>
                                </div>
...
<?php echo $__env->make('layout.asset-app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\DIU_Community\resources\views/edit-event.blade.php ENDPATH**/ ?>