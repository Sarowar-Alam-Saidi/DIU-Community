                ...
                <div class="card border mb-g">
                    <div class="card-body pl-4 pt-4 pr-4 pb-0">
                        ...
                        <div class="border-0 flex-1 position-relative shadow-top">
                            <form action="<?php echo e(url('/community-post')); ?>" method="post">
                                <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layout.asset-app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\DIU_Community\resources\views/welcome.blade.php ENDPATH**/ ?>