<?php $__env->startSection('content'); ?>
 ...
 <main id="js-page-content" role="main" class="page-content">
        ...
        <div class="row">
                ...
                <div class="card border mb-g">
                    <div class="card-body pl-4 pt-4 pr-4 pb-0">
                        ...
                        <div class="border-0 flex-1 position-relative shadow-top">
                            <form action="<?php echo e(url('/event-post')); ?>" method="post" enctype="multipart/form-data">
                                <?php echo csrf_field(); ?>
            ...
            <!-- post comment -->
                <div class="card mb-g">
                    <?php $__currentLoopData = $allEventPost; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $allComPost): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="card-body pb-0 px-4">
                        <div class="d-flex flex-row pb-3 pt-2  border-top-0 border-left-0 border-right-0">
                            ...
                            <h5 class="mb-0 flex-1 text-dark fw-500">
                                ...
                                <br>
                                <small class="m-0 l-h-n">
                                    Event Topic: <b><?php echo e($allComPost->eventType); ?></b>
                                </small>
                                <small class="m-0 l-h-n">
                                    Event Date: <b><?php echo e($allComPost->time); ?></b>
                                </small>
                            </h5>
                        ...
                        <div class="pb-3 pt-2 border-top-0 border-left-0 border-right-0 text-muted">
                           <img src="<?php echo asset('frontend/event/'.$allComPost->image); ?>" class="card-img-top" style="text-align: center; width: 50%;">
                        </div>
                        <div class="pb-3 pt-2 border-top-0 border-left-0 border-right-0 text-muted">
                        ...
                        <div class="d-flex align-items-center demo-h-spacing py-3">
                            <a href="javascript:void(0);" class="d-inline-flex align-items-center" style="color: green;">
                             ...
                             <?php if($allComPost->userID == Auth::user()->id): ?>    
                                <a href="<?php echo e(url('event-edit',$allComPost->id)); ?>" class="btn btn-sm btn-success">Edit</a>
                                <form class="form-inline" action="<?php echo route('event-delete', $allComPost->id); ?>" method="post">
                                <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layout.asset-app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\DIU_Community\resources\views/event.blade.php ENDPATH**/ ?>