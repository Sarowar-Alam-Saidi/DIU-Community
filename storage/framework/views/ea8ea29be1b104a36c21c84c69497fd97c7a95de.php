                    ...
                    <div class="card border mb-g">
                       <div class="card-body pl-4 pt-4 pr-4 pb-0">
                        ...
                        <div class="border-0 flex-1 position-relative shadow-top">
                            <form action="<?php echo e(url('/blood-update',$editblood->id)); ?>" method="post">
                                <?php echo csrf_field(); ?>
                                ...
                                <div class="form-group">
                                    <select class="form-control" id="example-select" name="bloodGroup" required>
                                        <option><?php echo e($editblood->bloodGroup); ?></option>
                                ...
                                <div class="form-group">
                                    <textarea class="form-control" id="example-textarea" rows="5" name="description" required><?php echo e($editblood->description); ?></textarea>
                                </div>
...
<?php echo $__env->make('layout.asset-app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\DIU_Community\resources\views/edit-blood.blade.php ENDPATH**/ ?>